...
def design_patterns_user_prompt(project_dir: Path) -> str:
    ...
    return (
        ...
        "- Include animation/transition specs only for interactive "
        "states that need them (hover, focus, loading).\n"
...
def spec_first_user_prompt(
    ...
    return (
        ...
        "- Include animation/transition specs only if the feature "
        "has interactive states that require them.\n\n"
