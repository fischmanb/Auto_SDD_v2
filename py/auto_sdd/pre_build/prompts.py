...
def design_patterns_user_prompt(project_dir: Path) -> str:
    ...
    return (
        ...
        "Address visual balance: when components share a row or "
        "section, the layout must avoid large empty regions adjacent "
        "to content. Define how the design handles height mismatches, "
        "uneven content density, and negative space across the page.\n\n"
        "## Component Anatomy\n"
