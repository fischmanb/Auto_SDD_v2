#!/usr/bin/env python3
"""
Edge-Finder daily runner for 2026-06-25 (Thursday).
Phase 1: Eval June 23 predictions (June 24 had no predictions), update weights.
Phase 2-5: Simulate tonight's games (MLB only — 9 games).
"""
...
# Actual results from June 23, 2026 — verified via ESPN/MLB.com search results
actual_results = {
    ...
    "Los Angeles Dodgers @ Minnesota Twins": {"winner": "away", "home_score": 3, "away_score": 12},
...
for challenger in assumptions["challengers"][:]:
    if challenger["weight"] <= 0.15 and challenger.get("born", "2026-01-01") < "2026-06-20":
        ...
        new_challenger = {
            "id": "public-fade-v1",
            "description": "Fade public betting sentiment: when line movement suggests heavy public action on one side, lean slightly toward the other side. Adds +0.15 regression toward the less popular side. Hypothesis: casual bettors overweight recent results and name recognition, creating value on less-glamorous teams.",
            "weight": 0.5,
            "born": TODAY,
            "grace_until": "2026-06-30",
            "params": {
                "recency_weight": 0.8,
                "injury_discount": 0.2,
...
# ════════════════════════════════════════════════════════════════════════
# PHASE 2 — DATA COLLECTION: Tonight's games (June 25, 2026 MLB)
# ════════════════════════════════════════════════════════════════════════

print(f"\n{'=' * 78}")
print(f" PHASE 2 — Data Collection: June 25, 2026 MLB games")
print(f"{'=' * 78}")

# Tonight's games and odds sourced via web search (FanDuel, DraftKings, BetMGM, bet365, ESPN)
# Team stats estimated from standings (NYY 47-31, LAD 51-29, MIL 48-29, ATL 48-30, SEA 41-39)
# and prior run baselines with adjustments for recent results.
games_today = [
    {
        "game": "Kansas City Royals @ Tampa Bay Rays",
        "home": "Tampa Bay Rays",
        "away": "Kansas City Royals",
        "home_stats": {"season_ppg": 4.6, "season_opp_ppg": 3.9, "last10_ppg": 4.4, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.60, "away_record_pct": 0.55, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.2, "season_opp_ppg": 4.4, "last10_ppg": 4.5, "last10_opp_ppg": 4.3, "season_pace": 1.0, "home_record_pct": 0.50, "away_record_pct": 0.42, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": -1.5, "ml_home": -140, "ml_away": 118, "total": 8.5, "book": "fanduel"},
    },
    {
        "game": "Seattle Mariners @ Pittsburgh Pirates",
        "home": "Pittsburgh Pirates",
        "away": "Seattle Mariners",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.1, "last10_ppg": 4.0, "last10_opp_ppg": 4.2, "season_pace": 1.0, "home_record_pct": 0.50, "away_record_pct": 0.46, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.0, "season_opp_ppg": 3.8, "last10_ppg": 3.8, "last10_opp_ppg": 3.5, "season_pace": 1.0, "home_record_pct": 0.55, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": 1.5, "ml_home": 116, "ml_away": -136, "total": 8.5, "book": "fanduel"},
    },
    {
        "game": "Sacramento Athletics @ San Francisco Giants",
        "home": "San Francisco Giants",
        "away": "Sacramento Athletics",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.2, "last10_ppg": 4.5, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.50, "away_record_pct": 0.42, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 3.8, "season_opp_ppg": 5.0, "last10_ppg": 3.5, "last10_opp_ppg": 5.2, "season_pace": 1.0, "home_record_pct": 0.38, "away_record_pct": 0.35, "is_back_to_back": False, "key_injuries": 2},
        "odds": {"spread_home": -1.5, "ml_home": -130, "ml_away": 110, "total": 8.5, "book": "fanduel"},
    },
    {
        "game": "Houston Astros @ Detroit Tigers",
        "home": "Detroit Tigers",
        "away": "Houston Astros",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.1, "last10_ppg": 4.2, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.54, "away_record_pct": 0.46, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.4, "season_opp_ppg": 4.0, "last10_ppg": 4.5, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
    ...
    },
    {
        ...
        "home_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.5, "last10_ppg": 4.8, "last10_opp_ppg": 5.0, "season_pace": 1.0, "home_record_pct": 0.52, "away_record_pct": 0.44, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 5.1, "season_opp_ppg": 3.8, "last10_ppg": 5.5, "last10_opp_ppg": 3.6, "season_pace": 1.0, "home_record_pct": 0.68, "away_record_pct": 0.58, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": 1.5, "ml_home": 153, "ml_away": -186, "total": 8.0, "book": "fanduel"},
    },
    {
        "game": "Texas Rangers @ Toronto Blue Jays",
        "home": "Toronto Blue Jays",
        "away": "Texas Rangers",
        "home_stats": {"season_ppg": 4.2, "season_opp_ppg": 4.5, "last10_ppg": 4.0, "last10_opp_ppg": 4.8, "season_pace": 1.0, "home_record_pct": 0.48, "away_record_pct": 0.42, "is_back_to_back": False, "key_injuries": 2},
        "away_stats": {"season_ppg": 4.0, "season_opp_ppg": 4.3, "last10_ppg": 4.2, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.48, "away_record_pct": 0.44, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": 1.5, "ml_home": 101, "ml_away": -122, "total": 8.0, "book": "fanduel"},
    },
    {
        "game": "Chicago Cubs @ New York Mets",
        "home": "New York Mets",
        "away": "Chicago Cubs",
        "home_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.2, "last10_ppg": 3.8, "last10_opp_ppg": 5.0, "season_pace": 1.0, "home_record_pct": 0.52, "away_record_pct": 0.46, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.6, "season_opp_ppg": 4.2, "last10_ppg": 5.5, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.54, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": 1.5, "ml_home": -108, "ml_away": -112, "total": 8.5, "book": "fanduel"},
    },
    {
        "game": "New York Yankees @ Boston Red Sox",
        "home": "Boston Red Sox",
        "away": "New York Yankees",
        "home_stats": {"season_ppg": 4.8, "season_opp_ppg": 4.0, "last10_ppg": 4.5, "last10_opp_ppg": 4.2, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 5.0, "season_opp_ppg": 3.9, "last10_ppg": 5.2, "last10_opp_ppg": 3.5, "season_pace": 1.0, "home_record_pct": 0.68, "away_record_pct": 0.58, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": 1.5, "ml_home": 130, "ml_away": -170, "total": 8.5, "book": "fanduel"},
    },
    {
        ...
        "away_stats": {"season_ppg": 4.6, "season_opp_ppg": 4.3, "last10_ppg": 4.8, "last10_opp_ppg": 4.2, "season_pace": 1.0, "home_record_pct": 0.54, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
...
print(f"\n{'=' * 90}")
print(f" MLB -- Thursday Jun 25, 2026")
print(f"{'=' * 90}")
...
metrics["today_summary"] = {
    ...
    "leans": len(leans),
    "sports": ["baseball_mlb"],
    "notes": f"MLB only. {len(bets)} BETs, {len(leans)} LEANs. Eval Jun 23: {total_correct_eval}/{total_games_eval} correct."
}
