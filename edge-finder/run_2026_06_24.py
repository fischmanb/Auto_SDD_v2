#!/usr/bin/env python3
"""
Edge-Finder daily runner for 2026-06-24 (Wednesday).
Phase 1: Eval June 23 predictions, update weights.
Phase 2-5: Simulate tonight's games (MLB only — no NBA/NHL/NFL in season).
"""
...
# ════════════════════════════════════════════════════════════════════════
# PHASE 1 — EVALUATE JUNE 23 PREDICTIONS
# ════════════════════════════════════════════════════════════════════════

print("=" * 78)
print(" PHASE 1 — Evaluating 2026-06-23 predictions")
print("=" * 78)
...
actual_results = {
    "Houston Astros @ Toronto Blue Jays": {"winner": "away", "home_score": 7, "away_score": 9},
    "New York Yankees @ Detroit Tigers": {"winner": "away", "home_score": 3, "away_score": 4},
    "Kansas City Royals @ Tampa Bay Rays": {"winner": "away", "home_score": 5, "away_score": 12},
    "Philadelphia Phillies @ Washington Nationals": {"winner": "away", "home_score": 9, "away_score": 14},
    "Chicago Cubs @ New York Mets": {"winner": "away", "home_score": 6, "away_score": 9},
    "Cleveland Guardians @ Chicago White Sox": {"winner": "home", "home_score": 2, "away_score": 1},
    "Seattle Mariners @ Pittsburgh Pirates": {"winner": "away", "home_score": 2, "away_score": 3},
    "Milwaukee Brewers @ Cincinnati Reds": {"winner": "away", "home_score": 0, "away_score": 2},
    "Los Angeles Dodgers @ Minnesota Twins": {"winner": "away", "home_score": 2, "away_score": 7},
    "Arizona Diamondbacks @ St. Louis Cardinals": {"winner": "away", "home_score": 3, "away_score": 4},
    "Boston Red Sox @ Colorado Rockies": {"winner": "away", "home_score": 2, "away_score": 5},
    "Atlanta Braves @ San Diego Padres": {"winner": "home", "home_score": 7, "away_score": 6},
    "Baltimore Orioles @ Los Angeles Angels": {"winner": "home", "home_score": 5, "away_score": 1},
}
...
for challenger in assumptions["challengers"][:]:
    if challenger["weight"] <= 0.15 and challenger.get("born", "2026-01-01") < "2026-06-19":
        ...
        new_challenger = {
            "id": "public-fade-v1",
            "description": "Fade public consensus: when >65% of public bets are on one side, adjust 0.3 runs toward the other side. Based on historical evidence that public money overweights favorites and recent trends, creating value on underdogs and unders in popular games.",
            "weight": 0.5,
            "born": TODAY,
            "grace_until": "2026-06-29",
            "params": {
                "recency_weight": 1.3,
                "injury_discount": 0.2,
                "home_advantage_adjustment": -0.1,
...
# ════════════════════════════════════════════════════════════════════════
# PHASE 2 — DATA COLLECTION: Tonight's games (June 24, 2026 MLB)
# ════════════════════════════════════════════════════════════════════════

print(f"\n{'=' * 78}")
print(f" PHASE 2 — Data Collection: June 24, 2026 MLB games")
print(f"{'=' * 78}")

games_today = [
    # 1. TEX @ MIA — deGrom (3.59 ERA) vs Pérez — TEX -125, MIA +105
    {
        "game": "Texas Rangers @ Miami Marlins",
        "home": "Miami Marlins",
        "away": "Texas Rangers",
        "home_stats": {"season_ppg": 4.4, "season_opp_ppg": 3.8, "last10_ppg": 4.8, "last10_opp_ppg": 3.5, "season_pace": 1.0, "home_record_pct": 0.58, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 0},
        "away_stats": {"season_ppg": 4.1, "season_opp_ppg": 4.1, "last10_ppg": 4.5, "last10_opp_ppg": 3.8, "season_pace": 1.0, "home_record_pct": 0.52, "away_record_pct": 0.44, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": 1.5, "ml_home": 105, "ml_away": -125, "total": 7.5, "book": "fanduel"},
    },
    # 2. CHC @ NYM (G1) — Assad vs McLean — CHC -118, NYM +100
    # Cubs leading MLB in BA last week (.324), won 3 of last 4. Mets lost 3 straight.
    {
        "game": "Chicago Cubs @ New York Mets",
        "home": "New York Mets",
        "away": "Chicago Cubs",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.4, "last10_ppg": 3.7, "last10_opp_ppg": 5.0, "season_pace": 1.0, "home_record_pct": 0.50, "away_record_pct": 0.42, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.6, "season_opp_ppg": 4.2, "last10_ppg": 5.3, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": 1.5, "ml_home": 100, "ml_away": -118, "total": 8.5, "book": "fanduel"},
    },
    # 3. CLE @ CHW — Bibee (4.81 FIP recent) vs Fedde — CLE -122, CHW +102
    # CLE on 3-game losing streak. CHW 41-37, leading AL Central.
    {
        "game": "Cleveland Guardians @ Chicago White Sox",
        "home": "Chicago White Sox",
        "away": "Cleveland Guardians",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.0, "last10_ppg": 4.5, "last10_opp_ppg": 3.7, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 0},
        "away_stats": {"season_ppg": 4.7, "season_opp_ppg": 3.8, "last10_ppg": 4.2, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.58, "away_record_pct": 0.52, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": 1.5, "ml_home": 102, "ml_away": -122, "total": 7.5, "book": "fanduel"},
    },
    # 4. BOS @ COL — Suárez vs Freeland — BOS -185, COL +152
    # COL 31-49, worst record in NL. BOS favored at Coors.
    {
        ...
        "away_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.2, "last10_ppg": 4.8, "last10_opp_ppg": 3.8, "season_pace": 1.0, "home_record_pct": 0.48, "away_record_pct": 0.40, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": 1.5, "ml_home": 152, "ml_away": -185, "total": 10.5, "book": "betmgm"},
    },
    # 5. BAL @ LAA — Gibson vs Soriano — BAL -142, LAA +120
    # BAL on 9-day road trip, travel fatigue. O/U 9.
    {
        "game": "Baltimore Orioles @ Los Angeles Angels",
        "home": "Los Angeles Angels",
        "away": "Baltimore Orioles",
        "home_stats": {"season_ppg": 3.9, "season_opp_ppg": 4.7, "last10_ppg": 4.2, "last10_opp_ppg": 4.3, "season_pace": 1.0, "home_record_pct": 0.42, "away_record_pct": 0.36, "is_back_to_back": False, "key_injuries": 2},
        "away_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.1, "last10_ppg": 4.6, "last10_opp_ppg": 3.8, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": 1.5, "ml_home": 120, "ml_away": -142, "total": 9.0, "book": "betmgm"},
    },
    # 6. HOU @ TOR — Burrows (5.79 ERA) vs Yesavage (3.76 ERA) — TOR -165, HOU +135
    # HOU's worst starter; Burrows 3-8, 5.79 ERA.
    {
        "game": "Houston Astros @ Toronto Blue Jays",
        "home": "Toronto Blue Jays",
        "away": "Houston Astros",
        "home_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.3, "last10_ppg": 4.8, "last10_opp_ppg": 4.2, "season_pace": 1.0, "home_record_pct": 0.52, "away_record_pct": 0.46, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.4, "season_opp_ppg": 4.0, "last10_ppg": 4.2, "last10_opp_ppg": 4.1, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 2},
        "odds": {"spread_home": -1.5, "ml_home": -165, "ml_away": 135, "total": 8.5, "book": "fanduel"},
    },
    # 7. NYY @ DET — LHP vs Tigers power — DET -134, NYY +114
    # Tigers rank 8th in ISO and 1st in flyball rate vs LHP in June.
    {
        "game": "New York Yankees @ Detroit Tigers",
        "home": "Detroit Tigers",
        "away": "New York Yankees",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.0, "last10_ppg": 4.6, "last10_opp_ppg": 3.7, "season_pace": 1.0, "home_record_pct": 0.58, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 0},
        "away_stats": {"season_ppg": 4.9, "season_opp_ppg": 4.0, "last10_ppg": 4.4, "last10_opp_ppg": 4.2, "season_pace": 1.0, "home_record_pct": 0.64, "away_record_pct": 0.54, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": -1.5, "ml_home": -134, "ml_away": 114, "total": 7.5, "book": "fanduel"},
    },
    # 8. PHI @ WAS — Nola (8-7) vs Mikolas (5.47 ERA) — PHI -152, WAS +128
    {
        ...
        "odds": {"spread_home": 1.5, "ml_home": 128, "ml_away": -152, "total": 8.0, "book": "fanduel"},
    },
    # 9. MIL @ CIN — Drohan vs Lowder — MIL -144, CIN +122
    # MIL 47-29, best record in NL Central. CIN coming off shutout loss.
    {
        "game": "Milwaukee Brewers @ Cincinnati Reds",
        "home": "Cincinnati Reds",
        "away": "Milwaukee Brewers",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.6, "last10_ppg": 4.5, "last10_opp_ppg": 4.4, "season_pace": 1.0, "home_record_pct": 0.50, "away_record_pct": 0.44, "is_back_to_back": False, "key_injuries": 1},
        ...
        "odds": {"spread_home": 1.5, "ml_home": 122, "ml_away": -144, "total": 8.5, "book": "fanduel"},
    },
    # 10. SEA @ PIT — SEA road favorite — SEA -120, PIT +102
    {
        "game": "Seattle Mariners @ Pittsburgh Pirates",
        "home": "Pittsburgh Pirates",
        "away": "Seattle Mariners",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.1, "last10_ppg": 4.1, "last10_opp_ppg": 4.1, "season_pace": 1.0, "home_record_pct": 0.52, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.1, "season_opp_ppg": 3.7, "last10_ppg": 4.0, "last10_opp_ppg": 3.6, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": 1.5, "ml_home": 102, "ml_away": -120, "total": 8.0, "book": "fanduel"},
    },
    # 11. TB @ KC — TB -146 road favorite, KC +124, O/U 7.5
    {
        "game": "Tampa Bay Rays @ Kansas City Royals",
        "home": "Kansas City Royals",
        "away": "Tampa Bay Rays",
        "home_stats": {"season_ppg": 4.2, "season_opp_ppg": 4.4, "last10_ppg": 4.0, "last10_opp_ppg": 4.5, "season_pace": 1.0, "home_record_pct": 0.50, "away_record_pct": 0.42, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.6, "season_opp_ppg": 3.9, "last10_ppg": 4.5, "last10_opp_ppg": 3.8, "season_pace": 1.0, "home_record_pct": 0.60, "away_record_pct": 0.55, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": 1.5, "ml_home": 124, "ml_away": -146, "total": 7.5, "book": "fanduel"},
    },
    # 12. LAD @ MIN — Ohtani (7-2, 1.47 ERA) vs Joe Ryan (2.99 ERA) — LAD -175, MIN +145
    # LAD 50-29, best in MLB. MIN at home.
    {
        "game": "Los Angeles Dodgers @ Minnesota Twins",
        "home": "Minnesota Twins",
        "away": "Los Angeles Dodgers",
        "home_stats": {"season_ppg": 4.6, "season_opp_ppg": 4.0, "last10_ppg": 4.8, "last10_opp_ppg": 4.2, "season_pace": 1.0, "home_record_pct": 0.55, "away_record_pct": 0.52, "is_back_to_back": False, "key_injuries": 0},
        "away_stats": {"season_ppg": 5.4, "season_opp_ppg": 3.7, "last10_ppg": 5.2, "last10_opp_ppg": 3.8, "season_pace": 1.0, "home_record_pct": 0.72, "away_record_pct": 0.62, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": 1.5, "ml_home": 145, "ml_away": -175, "total": 8.5, "book": "fanduel"},
    },
    # 13. ATL @ SD — ATL -130, SD +105
    # ATL 48-29, SD 40-37. Series continues after SD walk-off win yesterday.
    {
        "game": "Atlanta Braves @ San Diego Padres",
        "home": "San Diego Padres",
        "away": "Atlanta Braves",
        "home_stats": {"season_ppg": 4.7, "season_opp_ppg": 4.1, "last10_ppg": 4.9, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.58, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 1},
        ...
        "odds": {"spread_home": 1.5, "ml_home": 105, "ml_away": -130, "total": 8.0, "book": "fanduel"},
    },
]
...
print(f"\n{'=' * 90}")
print(f" MLB — Wednesday Jun 24, 2026")
print(f"{'=' * 90}")
...
if bets:
    ...
    for bet in bets:
        ...
        print(f"    Blended EV: {bet['best_blend_ev']:+.2%} | Spread: {bet['odds']['spread_home']:+.1f} | ML: {bet['odds']['ml_home']}/{bet['odds']['ml_away']}")
...
# Score BET results from Jun 23
jun23_bets = [p for p in past_preds["predictions"] if p.get("verdict") == "BET"]
jun23_bet_wins = 0
jun23_bet_total = len(jun23_bets)
for bp in jun23_bets:
    gk = bp["game"]
...
new_bets = old_bets + jun23_bet_total
new_bets_won = old_bets_won + jun23_bet_wins

metrics["last_updated"] = TODAY
metrics["rolling_7d"] = {
    "accuracy": round(total_correct_eval / total_games_eval, 4) if total_games_eval > 0 else 0.5,
    "ev_realized": round((jun23_bet_wins * 0.909 - (jun23_bet_total - jun23_bet_wins)) / max(jun23_bet_total, 1), 4),
...
metrics["today_summary"] = {
    ...
    "leans": len(leans),
    "sports": ["baseball_mlb"],
    "notes": f"MLB only. {len(bets)} BETs, {len(leans)} LEANs. Eval Jun 23: {total_correct_eval}/{total_games_eval} correct. Jun 23 bets: {jun23_bet_wins}/{jun23_bet_total} won."
}
...
print(f"  Jun 23 eval: {total_correct_eval}/{total_games_eval} = {total_correct_eval/max(total_games_eval,1):.1%} accuracy")
print(f"  Jun 23 bets: {jun23_bet_wins}/{jun23_bet_total} = {jun23_bet_wins/max(jun23_bet_total,1):.1%} hit rate")
