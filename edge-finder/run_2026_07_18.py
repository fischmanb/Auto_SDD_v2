#!/usr/bin/env python3
"""
Edge-Finder daily runner for 2026-07-18.
Phase 1: Eval July 17 predictions (11 MLB games; PIT@CLE postponed).
...
# ════════════════════════════════════════════════════════════════════════
# PHASE 1 — EVALUATE JULY 17 PREDICTIONS
# ════════════════════════════════════════════════════════════════════════

print("=" * 78)
print(" PHASE 1 — Evaluating 2026-07-17 predictions")
print("=" * 78)
...
# Actual results from July 17, 2026 (sourced via ESPN, MLB.com, web search)
# PIT @ CLE postponed due to weather; makeup DH on July 18.
# 11 games completed. BOS 11-game win streak snapped by TB.
actual_results = {
    "Tampa Bay Rays @ Boston Red Sox": {"winner": "away", "home_score": 1, "away_score": 3},
    "Los Angeles Dodgers @ New York Yankees": {"winner": "away", "home_score": 1, "away_score": 2},
    "Texas Rangers @ Atlanta Braves": {"winner": "home", "home_score": 15, "away_score": 1},
    "Chicago White Sox @ Toronto Blue Jays": {"winner": "away", "home_score": 4, "away_score": 12},
    "Miami Marlins @ Milwaukee Brewers": {"winner": "home", "home_score": 2, "away_score": 1},
    "Minnesota Twins @ Chicago Cubs": {"winner": "away", "home_score": 2, "away_score": 5},
    "San Diego Padres @ Kansas City Royals": {"winner": "home", "home_score": 7, "away_score": 6},
    "Baltimore Orioles @ Houston Astros": {"winner": "away", "home_score": 2, "away_score": 3},
    "Cincinnati Reds @ Colorado Rockies": {"winner": "away", "home_score": 2, "away_score": 7},
    "Detroit Tigers @ Los Angeles Angels": {"winner": "away", "home_score": 1, "away_score": 2},
    "St. Louis Cardinals @ Arizona Diamondbacks": {"winner": "away", "home_score": 4, "away_score": 5},
}
...
for c in challengers:
    ...
    days_alive = (date(2026, 7, 18) - date(int(born[:4]), int(born[5:7]), int(born[8:10]))).days
...
# ═══════════════════════════════════════════════════════════════════════
# PHASE 2-5 — TONIGHT'S PREDICTIONS (July 18, 2026)
# ═══════════════════════════════════════════════════════════════════════
...
# Saturday July 18, 2026 — MLB only (NBA/NHL/NFL off-season)
# 15 games (PIT@CLE Game 1 of makeup DH from 7/17 postponement).
# Odds sourced from FanDuel, DraftKings, BetMGM, OddsShark, Covers, ESPN.
# Records through July 17. Stats estimated from standings and recent form.

games_raw = [
    # 1. MIN Twins @ CHC Cubs — 2:20 PM ET
    # MIN 49-49, CHC 54-43. Cubs home favorite. CHC won 5-2 on Jul 16 but MIN won 5-2 on Jul 17.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Chicago Cubs",
    ...
    # 2. CWS White Sox @ TOR Blue Jays — 3:07 PM ET
    # CWS 51-45 (1st AL Central), TOR 45-51. CWS road favorite after 12-4 rout.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 3. CIN Reds @ COL Rockies — 3:10 PM ET (Coors Field)
    # CIN 41-47, COL 36-54. Coors inflated total. Reds won 7-2 yesterday (Steer 2 HR).
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 4. NYM Mets @ PHI Phillies — 4:05 PM ET
    # NYM 41-57, PHI 54-44. Phillies strong home favorites. PHI lost to NYM Jul 16.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 5. BAL Orioles @ HOU Astros — 4:10 PM ET
    # BAL 48-51, HOU 47-52. Near pick'em. BAL won 3-2 yesterday.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Houston Astros",
    ...
    # 6. PIT Pirates @ CLE Guardians — 4:10 PM ET (Game 1 of DH, makeup from Jul 17)
    # PIT 44-45, CLE 47-42. Pick'em line for DH Game 1.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 7. SD Padres @ KC Royals — 4:10 PM ET
    # SD 43-44, KC 36-53. SD road favorite. KC won 7-6 upset yesterday.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 8. TB Rays @ BOS Red Sox — 4:10 PM ET
    # TB 57-39 (1st AL East), BOS 46-49. TB won G1 yesterday (3-1). BOS streak snapped at 11.
    # Both played DH yesterday — marking as back-to-back.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Boston Red Sox",
    ...
    # 9. TEX Rangers @ ATL Braves — 4:10 PM ET
    # TEX 49-48, ATL 56-40. ATL won 15-1 rout yesterday. Braves home favorite.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Atlanta Braves",
    ...
    # 10. MIA Marlins @ MIL Brewers — 4:10 PM ET
    # MIA 47-43, MIL 55-32. MIL dominant at home. MIL won 2-1 yesterday.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 11. STL Cardinals @ ARI Diamondbacks — 4:10 PM ET
    # STL 47-39, ARI 43-45. STL won 5-4 in 9th inning yesterday (Herrera walk-off RBI).
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 12. SF Giants @ SEA Mariners — 8:08 PM ET
    # SF ~40-50, SEA ~44-46. SEA home favorite. SF underdog play with disciplined offense (108 wRC+).
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 13. LAD Dodgers @ NYY Yankees — 8:08 PM ET
    # LAD 62-36 (best in MLB), NYY 49-39. Near pick'em. LAD won 2-1 yesterday.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 14. WSH Nationals @ OAK Athletics — 10:05 PM ET
    # WSH ~38-55, OAK ~34-56. OAK favored despite weak record (pitching matchup).
    # WSH has top-2 offense (hot bats). OAK weak pitching but favored by line.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 15. DET Tigers @ LAA Angels — 10:07 PM ET
    # DET 39-50, LAA 36-54. DET heavy road favorite (-194). DET won 2-1 yesterday.
    {
        "sport": "baseball_mlb",
        "home": {
...
pred_data = {
    ...
    "metadata": {
        ...
        "data_sources": ["web search (ESPN, MLB.com, FanDuel, DraftKings, BetMGM, OddsShark, Covers)"],
        "note": "ODDS_API_KEY not configured; odds sourced from web search. PIT@CLE Game 1 of makeup DH from Jul 17 postponement."
    }
}
...
# ── Display results ──────────────────────────────────────────────────
print(f"\n{'=' * 90}")
print(f" MLB — Saturday July 18, 2026")
print(f"{'=' * 90}")
...
jul17_bets = [p for p in past_preds["predictions"] if p["verdict"] == "BET"]
jul17_bet_wins = 0
jul17_bet_total = len(jul17_bets)
for bp in jul17_bets:
    gk = bp["game"]
...
new_all_bets = prev_all["total_bets_recommended"] + jul17_bet_total
new_all_bets_won = prev_all["total_bets_won"] + jul17_bet_wins

metrics["last_updated"] = TODAY
metrics["rolling_7d"] = {
    "accuracy": round(eval_correct / eval_games, 4) if eval_games > 0 else 0.5,
    "ev_realized": round((jul17_bet_wins * 0.909 - (jul17_bet_total - jul17_bet_wins)) / max(jul17_bet_total, 1), 4),
...
metrics["today_summary"] = {
    ...
    "sports": ["baseball_mlb"],
    "notes": f"MLB Saturday slate (15 games incl PIT@CLE makeup DH G1). Eval Jul 17: {eval_correct}/{eval_games} correct ({eval_acc:.0%}). Jul 17 bets: {jul17_bet_wins}/{jul17_bet_total} won. ATL 15-1 rout of TEX, CWS 12-4 over TOR."
}
