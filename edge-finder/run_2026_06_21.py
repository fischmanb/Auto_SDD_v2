#!/usr/bin/env python3
"""
Edge-Finder daily runner for 2026-06-21 (Sunday).
Phase 1: Eval June 20 predictions, update weights.
...
# ════════════════════════════════════════════════════════════════════════
# PHASE 1 — EVALUATE JUNE 20 PREDICTIONS
# ════════════════════════════════════════════════════════════════════════

print("=" * 78)
print(" PHASE 1 — Evaluating 2026-06-20 predictions")
print("=" * 78)
...
# Actual results fetched via web search (June 20, 2026)
# Sources: ESPN, CBS Sports, Baseball-Reference, FoxSports, MLB.com
actual_results = {
    ...
    "Toronto Blue Jays @ Chicago Cubs": {"winner": "away", "home_score": 6, "away_score": 8},
    "San Diego Padres @ Texas Rangers": {"winner": "away", "home_score": 4, "away_score": 6},
    "Washington Nationals @ Tampa Bay Rays": {"winner": "away", "home_score": 3, "away_score": 4},
    "San Francisco Giants @ Miami Marlins": {"winner": "home", "home_score": 6, "away_score": 3},
    "Milwaukee Brewers @ Atlanta Braves": {"winner": "home", "home_score": 4, "away_score": 3},
    "Cleveland Guardians @ Houston Astros": {"winner": "away", "home_score": 1, "away_score": 8},
    # Cardinals @ Royals: NO GAME — off day (World Cup at adjacent Arrowhead)
    "New York Mets @ Philadelphia Phillies": {"winner": "home", "home_score": 15, "away_score": 3},
    "Pittsburgh Pirates @ Colorado Rockies": {"winner": "home", "home_score": 2, "away_score": 1},
    "Los Angeles Angels @ Sacramento Athletics": {"winner": "away", "home_score": 0, "away_score": 7},
    "Minnesota Twins @ Arizona Diamondbacks": {"winner": "away", "home_score": 8, "away_score": 16},
    "Baltimore Orioles @ Los Angeles Dodgers": {"winner": "away", "home_score": 2, "away_score": 3},
    "Boston Red Sox @ Seattle Mariners": {"winner": "away", "home_score": 1, "away_score": 5},
}
...
for pred in past_preds["predictions"]:
    ...
    if game_key not in actual_results:
        print(f"  ⚠️  Skipping {game_key} — no actual result (likely off-day)")
        continue
...
# Print model performance for June 20
...
# Promotion check (rolling 10-day: use lifetime as proxy since we track it)
...
for challenger in assumptions["challengers"]:
    if challenger["weight"] <= 0.15 and challenger.get("born", "2026-01-01") < "2026-06-16":
        ...
        new_challenger = {
            "id": "public-fade-v1",
            "description": "Fade heavy public betting sides: when >70% of bets are on one side, add value to the contrarian side. Based on well-documented 'fade the public' edge in MLB where sharp vs public money diverges.",
            "weight": 0.5,
            "born": TODAY,
            "grace_until": "2026-06-26",
            "params": {
                "recency_weight": 1.0,
                "injury_discount": 0.0,
...
# ════════════════════════════════════════════════════════════════════════
# PHASE 2 — DATA COLLECTION: Tonight's games (June 21, 2026 MLB)
# ════════════════════════════════════════════════════════════════════════

print("\n" + "=" * 78)
print(" PHASE 2 — Data Collection: June 21, 2026 MLB games")
print("=" * 78)

# Today's games and odds sourced from web search (FanDuel, ESPN, bet365, DraftKings)
# Note: Cardinals @ Royals also playing today after yesterday's off day
games_today = [
    {
        ...
        "away_stats": {"season_ppg": 3.2, "season_opp_ppg": 5.1, "last10_ppg": 3.0, "last10_opp_ppg": 4.8, "season_pace": 1.0, "home_record_pct": 0.35, "away_record_pct": 0.30, "is_back_to_back": False, "key_injuries": 2},
        "odds": {"spread_home": -1.5, "ml_home": -116, "ml_away": -102, "total": 8.0, "book": "fanduel"},
    },
    {
        "game": "Cincinnati Reds @ New York Yankees",
        "home": "New York Yankees",
        "away": "Cincinnati Reds",
        "home_stats": {"season_ppg": 5.2, "season_opp_ppg": 3.9, "last10_ppg": 4.5, "last10_opp_ppg": 4.2, "season_pace": 1.0, "home_record_pct": 0.68, "away_record_pct": 0.58, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.4, "season_opp_ppg": 4.6, "last10_ppg": 5.2, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.50, "away_record_pct": 0.44, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": -1.5, "ml_home": -120, "ml_away": 102, "total": 9.0, "book": "fanduel"},
    },
    {
        "game": "Toronto Blue Jays @ Chicago Cubs",
        "home": "Chicago Cubs",
        "away": "Toronto Blue Jays",
        "home_stats": {"season_ppg": 4.6, "season_opp_ppg": 4.2, "last10_ppg": 5.1, "last10_opp_ppg": 4.5, "season_pace": 1.0, "home_record_pct": 0.54, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.5, "last10_ppg": 4.8, "last10_opp_ppg": 4.3, "season_pace": 1.0, "home_record_pct": 0.48, "away_record_pct": 0.45, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": -1.5, "ml_home": -104, "ml_away": -126, "total": 9.0, "book": "fanduel"},
    },
    {
        "game": "Washington Nationals @ Tampa Bay Rays",
        "home": "Tampa Bay Rays",
        "away": "Washington Nationals",
        "home_stats": {"season_ppg": 4.8, "season_opp_ppg": 4.0, "last10_ppg": 4.5, "last10_opp_ppg": 3.8, "season_pace": 1.0, "home_record_pct": 0.60, "away_record_pct": 0.55, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.3, "last10_ppg": 4.2, "last10_opp_ppg": 4.5, "season_pace": 1.0, "home_record_pct": 0.55, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": -1.5, "ml_home": -134, "ml_away": 116, "total": 8.0, "book": "fanduel"},
    },
    {
        "game": "San Francisco Giants @ Miami Marlins",
        "home": "Miami Marlins",
        "away": "San Francisco Giants",
        "home_stats": {"season_ppg": 3.9, "season_opp_ppg": 4.6, "last10_ppg": 4.4, "last10_opp_ppg": 4.2, "season_pace": 1.0, "home_record_pct": 0.45, "away_record_pct": 0.35, "is_back_to_back": False, "key_injuries": 2},
        "away_stats": {"season_ppg": 4.2, "season_opp_ppg": 4.4, "last10_ppg": 3.8, "last10_opp_ppg": 4.6, "season_pace": 1.0, "home_record_pct": 0.46, "away_record_pct": 0.42, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": 1.5, "ml_home": 124, "ml_away": -146, "total": 8.5, "book": "fanduel"},
    },
    {
        "game": "Milwaukee Brewers @ Atlanta Braves",
        "home": "Atlanta Braves",
        "away": "Milwaukee Brewers",
        "home_stats": {"season_ppg": 5.0, "season_opp_ppg": 4.0, "last10_ppg": 4.5, "last10_opp_ppg": 3.8, "season_pace": 1.0, "home_record_pct": 0.66, "away_record_pct": 0.60, "is_back_to_back": False, "key_injuries": 1},
        ...
        "odds": {"spread_home": -1.5, "ml_home": -148, "ml_away": 115, "total": 8.0, "book": "bet365"},
    },
    {
        "game": "Texas Rangers @ San Diego Padres",
        "home": "San Diego Padres",
        "away": "Texas Rangers",
        "home_stats": {"season_ppg": 4.7, "season_opp_ppg": 4.1, "last10_ppg": 5.0, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.58, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.2, "last10_ppg": 4.8, "last10_opp_ppg": 4.3, "season_pace": 1.0, "home_record_pct": 0.55, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": 1.5, "ml_home": 126, "ml_away": -148, "total": 8.0, "book": "fanduel"},
    },
    {
        "game": "Cleveland Guardians @ Houston Astros",
        "home": "Houston Astros",
        "away": "Cleveland Guardians",
        "home_stats": {"season_ppg": 4.6, "season_opp_ppg": 3.9, "last10_ppg": 4.2, "last10_opp_ppg": 4.1, "season_pace": 1.0, "home_record_pct": 0.58, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.8, "season_opp_ppg": 3.7, "last10_ppg": 5.2, "last10_opp_ppg": 3.5, "season_pace": 1.0, "home_record_pct": 0.60, "away_record_pct": 0.55, "is_back_to_back": False, "key_injuries": 0},
    ...
    },
    {
        ...
        "home_stats": {"season_ppg": 4.4, "season_opp_ppg": 4.3, "last10_ppg": 5.0, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.52, "away_record_pct": 0.45, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.4, "last10_ppg": 4.0, "last10_opp_ppg": 4.6, "season_pace": 1.0, "home_record_pct": 0.50, "away_record_pct": 0.46, "is_back_to_back": False, "key_injuries": 1},
    ...
    },
    {
        ...
        "away": "New York Mets",
        "home_stats": {"season_ppg": 5.1, "season_opp_ppg": 3.8, "last10_ppg": 5.8, "last10_opp_ppg": 3.5, "season_pace": 1.0, "home_record_pct": 0.68, "away_record_pct": 0.60, "is_back_to_back": False, "key_injuries": 0},
        "away_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.2, "last10_ppg": 4.0, "last10_opp_ppg": 4.5, "season_pace": 1.0, "home_record_pct": 0.52, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": -1.5, "ml_home": -184, "ml_away": 154, "total": 8.5, "book": "fanduel"},
    },
    {
        ...
        "away_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.1, "last10_ppg": 3.8, "last10_opp_ppg": 3.9, "season_pace": 1.0, "home_record_pct": 0.52, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": 1.5, "ml_home": 125, "ml_away": -165, "total": 9.5, "book": "bet365"},
    },
    {
        "game": "Los Angeles Angels @ Sacramento Athletics",
        "home": "Sacramento Athletics",
        "away": "Los Angeles Angels",
        "home_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.0, "last10_ppg": 4.2, "last10_opp_ppg": 3.9, "season_pace": 1.0, "home_record_pct": 0.58, "away_record_pct": 0.52, "is_back_to_back": False, "key_injuries": 0},
        "away_stats": {"season_ppg": 3.8, "season_opp_ppg": 4.8, "last10_ppg": 4.2, "last10_opp_ppg": 4.5, "season_pace": 1.0, "home_record_pct": 0.40, "away_record_pct": 0.36, "is_back_to_back": False, "key_injuries": 2},
        "odds": {"spread_home": -1.5, "ml_home": -164, "ml_away": 138, "total": 9.5, "book": "fanduel"},
    },
    {
        "game": "Minnesota Twins @ Arizona Diamondbacks",
        "home": "Arizona Diamondbacks",
        "away": "Minnesota Twins",
        "home_stats": {"season_ppg": 4.6, "season_opp_ppg": 4.3, "last10_ppg": 4.8, "last10_opp_ppg": 5.0, "season_pace": 1.0, "home_record_pct": 0.55, "away_record_pct": 0.45, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.7, "season_opp_ppg": 4.0, "last10_ppg": 5.5, "last10_opp_ppg": 3.8, "season_pace": 1.0, "home_record_pct": 0.55, "away_record_pct": 0.52, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": -1.5, "ml_home": -131, "ml_away": 101, "total": 8.5, "book": "bet365"},
    },
    {
        "game": "Baltimore Orioles @ Los Angeles Dodgers",
        "home": "Los Angeles Dodgers",
        "away": "Baltimore Orioles",
        "home_stats": {"season_ppg": 5.4, "season_opp_ppg": 3.7, "last10_ppg": 5.0, "last10_opp_ppg": 3.9, "season_pace": 1.0, "home_record_pct": 0.72, "away_record_pct": 0.62, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.4, "season_opp_ppg": 4.0, "last10_ppg": 4.2, "last10_opp_ppg": 3.8, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.52, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": -1.5, "ml_home": -235, "ml_away": 175, "total": 8.0, "book": "bet365"},
    },
    {
        "game": "Boston Red Sox @ Seattle Mariners",
        "home": "Seattle Mariners",
        "away": "Boston Red Sox",
        "home_stats": {"season_ppg": 4.0, "season_opp_ppg": 3.8, "last10_ppg": 3.5, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.55, "away_record_pct": 0.45, "is_back_to_back": False, "key_injuries": 1},
        ...
        "odds": {"spread_home": -1.5, "ml_home": -148, "ml_away": 115, "total": 7.5, "book": "bet365"},
    },
]
...
for i, game in enumerate(games_today):
    ...
    # Best EV across all bet types for each model
    model_results = {}
    evs_by_model = []
...
print(f"\n┌{'─' * 85}┐")
print(f"│ {'MLB — Sunday Jun 21, 2026':<83} │")
...
metrics["all_time"]["total_bets_won"] = old_correct + total_correct_eval
...
metrics["today_summary"] = {
    ...
    "leans": len(leans),
    "sports": ["baseball_mlb"],
    "notes": f"MLB only. {len(bets)} BETs, {len(leans)} LEANs. Eval Jun 20: {total_correct_eval}/{total_games_eval} correct."
}
