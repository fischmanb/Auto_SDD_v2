#!/usr/bin/env python3
"""
Edge-Finder daily runner for 2026-07-02.
...
for c in challengers:
    born = c.get("born", "2026-03-24")
    days_alive = (date(2026, 7, 2) - date(int(born[:4]), int(born[5:7]), int(born[8:10]))).days
...
# ════════════════════════════════════════════════════════════════════════
# PHASE 2-5 — TONIGHT'S PREDICTIONS (July 2, 2026)
# ════════════════════════════════════════════════════════════════════════
...
games_raw = [
    # 1. Chicago White Sox (45-39) @ Cleveland Guardians (44-42)
    # CHW -118, CLE +100. O/U 8.5.
    # Davis Martin (9-3) vs Slade Cecconi (4-6).
    # CHW 1st in AL Central, CLE 2nd. White Sox have been dominant.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 2. St. Louis Cardinals (44-38) @ Atlanta Braves (49-34)
    # ATL -116, STL -106. O/U 8.5.
    # Close matchup, Braves slight home favorites.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Atlanta Braves",
    ...
    # 3. Tampa Bay Rays (49-33) @ Kansas City Royals (35-51)
    # TB -118, KC +100. O/U 10.5.
    # Seymour (4-1) vs Kolek (4-2, uncertain availability).
    # TB best record in AL, KC worst in AL Central.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 4. Detroit Tigers (37-49) @ Texas Rangers (44-42)
    # TEX -124, DET +106. O/U 7. Run line TEX -1.5 (+180/-220).
    # TEX 1st in AL West, DET struggling at 37-49.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Texas Rangers",
    ...
    # 5. Los Angeles Angels (36-51) @ Seattle Mariners (44-43)
    # SEA -210, LAA +176. O/U 7.5.
    # SEA big home favorite. Kirby dominant in last outing (8 IP, 6-2 win on Jun 29).
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 6. San Diego Padres (43-41) @ Los Angeles Dodgers (56-31)
    # LAD -198, SD +162. O/U 9.0. Run line LAD -1.5 (+105/-126).
    # LAD best record in MLB, at home.
    {
        "sport": "baseball_mlb",
        "home": {
...
print(f"\n{'=' * 90}")
print(f" MLB — Thursday July 2, 2026")
print(f"{'=' * 90}")
