#!/usr/bin/env python3
"""
Edge-Finder daily runner for 2026-06-12.
...
actual_results = {
    "Vegas Golden Knights @ Carolina Hurricanes": {
        ...
        "away_score": 2,
        "margin": 2,
        "note": "CAR 4-2, Svechnikov 2 PPG, Staal goal in 5th straight, CAR leads 3-2"
    },
    ...
    "Minnesota Twins @ Detroit Tigers": {
        ...
        "away_score": 0,
        "margin": 11,
        "note": "DET 11-0, Tigers hit 6 HR, Torkelson HR"
    },
    "Arizona Diamondbacks @ Miami Marlins": {
        ...
        "away_score": 0,
        "margin": 2,
        "note": "MIA 2-0, Marlins win 5th straight, sweep ARI"
    },
    "Texas Rangers @ Kansas City Royals": {
        ...
        "away_score": 4,
        "margin": -2,
        "note": "TEX 4-2, Carter RBI single, Latz 3K in 2 hitless IP"
    },
    "Chicago Cubs @ Colorado Rockies": {
        ...
        "away_score": 9,
        "margin": -6,
        "note": "CHC 9-3, Suzuki grand slam, Bregman 2-run HR"
    },
    "Los Angeles Dodgers @ Pittsburgh Pirates": {
        ...
        "away_score": 8,
        "margin": -2,
        "note": "LAD 8-6, Dreyer W, Scott SV7. Ohtani exited 7th with knee injury"
    },
    "Seattle Mariners @ Baltimore Orioles": {
        ...
        "away_score": 5,
        "margin": 2,
        "note": "BAL 7-5, Alonso HR caps 6-run 3rd vs Woo"
    },
    "Atlanta Braves @ Chicago White Sox": {
        ...
        "away_score": 0,
        "margin": 0,
        "note": "Postponed due to rain, rescheduled for August"
    },
}
...
retired = []
for c in challengers:
    if c["weight"] <= 0.15 and c["born"] < "2026-06-07":
        retired.append(c)
...
# ════════════════════════════════════════════════════════════════════════
# PHASE 2-5 — TONIGHT'S PREDICTIONS (June 12, 2026)
# ════════════════════════════════════════════════════════════════════════
...
# Sports in season tonight: MLB only (15 games)
# NHL: Game 6 is Sunday June 14
# NBA: Game 5 is Saturday June 13

games_raw = [
    # 1. Miami Marlins (35-35) @ Pittsburgh Pirates (36-34)
    # MIA on 5-game win streak, swept ARI. PIT -154 / MIA +130. O/U 8.5.
    # Alcantara (5-4, 4.43) vs Ashcraft (5-3, 3.28).
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 2. Seattle Mariners (36-35) @ Washington Nationals (35-35)
    # SEA -146 / WSH +124. O/U 8.0. Miller (SEA) vs Littell (WSH).
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 3. San Diego Padres (33-36) @ Baltimore Orioles (33-37)
    # BAL -142 / SD +120. O/U 8.5. Baz (SD) vs Canning (BAL).
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 4. Detroit Tigers (30-40) @ Cleveland Guardians (37-33)
    # CLE -186 / DET +155. O/U 8.5. Sonny Gray vs Jack Leiter.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 5. Texas Rangers (34-34) @ Boston Red Sox (27-40)
    # BOS -130 / TEX +110. O/U 9.0. Tanner Bibee vs Jack Flaherty.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Boston Red Sox",
    ...
    # 6. Arizona Diamondbacks (34-34) @ Cincinnati Reds (32-37)
    # ARI -116 / CIN -102. O/U 9.5.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 7. Atlanta Braves (45-23) @ New York Mets (30-38)
    # NYM -116 / ATL -102. O/U 8.5. Mets home fav despite worse record (pitching matchup).
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "New York Mets",
    ...
    # 8. New York Yankees (41-26) @ Toronto Blue Jays (33-36)
    # TOR -112 / NYY -108. O/U 8.5. Judge out with injury.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 9. Los Angeles Dodgers (45-25) @ Chicago White Sox (36-32)
    # LAD -137 / CHW +114. O/U 9.0. CHW 7-game home win streak.
    # Ohtani exited yesterday with knee injury - may be out.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 10. Philadelphia Phillies (30-38) @ Milwaukee Brewers (40-28)
    # MIL -255 / PHI +210. O/U 7.5. Heavy favorite.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 11. Houston Astros (36-33) @ Kansas City Royals (33-35)
    # HOU -119 / KC -102. O/U 9.0.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 12. St. Louis Cardinals (37-30) @ Minnesota Twins (32-37)
    # MIN -137 / STL +114. O/U 8.5.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 13. Tampa Bay Rays (37-32) @ Los Angeles Angels (29-39)
    # TB -170 / LAA +140. O/U 8.5.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 14. Colorado Rockies (26-43) @ Sacramento Athletics (35-33)
    # SAC -181 / COL +149. O/U 8.5.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 15. Chicago Cubs (36-34) @ San Francisco Giants (28-41)
    # CHC -130 / SF +110. O/U 8.5. Suzuki grand slam yesterday.
    {
        "sport": "baseball_mlb",
        "home": {
...
# Build sim batch: 15 games x 6 models = 90 simulations
batch = []
...
metrics["rolling_30d"] = {
    ...
    "total_correct": champ_total_correct,
}
...
metrics["today_summary"] = {
    ...
    "leans": leans_today,
    "sports": ["baseball_mlb"],
    "notes": f"15 MLB games. {bets_today} BETs, {leans_today} LEANs, {no_bets_today} NO BETs. Eval: Jun 11 was {model_correct.get(champ_id,0)}/{eval_games_played} correct."
}
...
for sport_key, sport_preds in sports.items():
    ...
    print(f"\n┌─────────────────────────────────────────────────────────────────────────────────┐")
    print(f"│ {label} — Friday Jun 12, 2026{' ' * (56 - len(label))}│")
    print(f"├────────────────────────────┬────────┬────────┬───────┬───────┬──────┬───────────┤")
