#!/usr/bin/env python3
"""
Edge-Finder daily runner for 2026-06-26 (Friday).
Phase 1: Eval June 25 predictions, update weights.
...
# ════════════════════════════════════════════════════════════════════════
# PHASE 1 — EVALUATE JUNE 25 PREDICTIONS
# ════════════════════════════════════════════════════════════════════════

print("=" * 78)
print(" PHASE 1 — Evaluating 2026-06-25 predictions")
print("=" * 78)
...
# Actual results from June 25, 2026 — verified via ESPN/MLB.com/CBS Sports search results
actual_results = {
    "Kansas City Royals @ Tampa Bay Rays": {"winner": "home", "home_score": 13, "away_score": 2},
    "Seattle Mariners @ Pittsburgh Pirates": {"winner": "home", "home_score": 5, "away_score": 1},
    "Sacramento Athletics @ San Francisco Giants": {"winner": "away", "home_score": 6, "away_score": 9},
    "Houston Astros @ Detroit Tigers": {"winner": "away", "home_score": 1, "away_score": 2},
    "Philadelphia Phillies @ Washington Nationals": {"winner": "away", "home_score": 5, "away_score": 10},
    "Texas Rangers @ Toronto Blue Jays": {"winner": "away", "home_score": 5, "away_score": 6},
    "Chicago Cubs @ New York Mets": {"winner": "away", "home_score": 3, "away_score": 4},
    "New York Yankees @ Boston Red Sox": {"winner": "home", "home_score": 6, "away_score": 3},
    # Arizona Diamondbacks @ St. Louis Cardinals: POSTPONED (rain, makeup July 23)
}
...
for challenger in assumptions["challengers"][:]:
    if challenger["weight"] <= 0.15 and challenger.get("born", "2026-01-01") < "2026-06-21":
        ...
        # Check graveyard for ideas to avoid
        graveyard_ideas = [g["id"] for g in assumptions.get("graveyard", [])]
        new_challenger = {
            "id": "divisional-rivalry-v1",
            "description": "Divisional rivalry adjustment: games between division opponents get a 5% regression toward coin-flip outcomes. Hypothesis: divisional familiarity narrows performance gaps — teams in the same division know each other's tendencies well, making outcomes less predictable than season-long stats suggest.",
            "weight": 0.5,
            "born": TODAY,
            "grace_until": "2026-07-01",
            "params": {
                "recency_weight": 1.0,
                "injury_discount": 0.3,
...
# ════════════════════════════════════════════════════════════════════════
# PHASE 2 — DATA COLLECTION: Tonight's games (June 26, 2026 MLB)
# ════════════════════════════════════════════════════════════════════════

print(f"\n{'=' * 78}")
print(f" PHASE 2 — Data Collection: June 26, 2026 MLB games (15 games)")
print(f"{'=' * 78}")

# Tonight's 15 games and odds sourced via web search (FanDuel, DraftKings, ESPN, BetMGM, NBC Sports)
# Team stats estimated from prior run baselines, standings, and recent results.
# Records from search results: ATL 48-31, LAD 52-29, MIL ~50-28, NYY ~48-32,
# CWS 41-38, ATH 39-42, SF 33-47, KC 34-48, LAA 34-48, COL ~30-49
games_today = [
    {
        "game": "Houston Astros @ Detroit Tigers",
        "home": "Detroit Tigers",
        "away": "Houston Astros",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.1, "last10_ppg": 4.2, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.54, "away_record_pct": 0.46, "is_back_to_back": True, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.4, "season_opp_ppg": 4.0, "last10_ppg": 4.5, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.48, "is_back_to_back": True, "key_injuries": 1},
        "odds": {"spread_home": -1.5, "ml_home": -114, "ml_away": -105, "total": 8.0, "book": "draftkings"},
    },
    {
        "game": "Cincinnati Reds @ Pittsburgh Pirates",
        "home": "Pittsburgh Pirates",
        "away": "Cincinnati Reds",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.1, "last10_ppg": 4.2, "last10_opp_ppg": 3.8, "season_pace": 1.0, "home_record_pct": 0.52, "away_record_pct": 0.46, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.1, "season_opp_ppg": 4.5, "last10_ppg": 3.8, "last10_opp_ppg": 4.6, "season_pace": 1.0, "home_record_pct": 0.46, "away_record_pct": 0.40, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": -1.5, "ml_home": -190, "ml_away": 160, "total": 7.5, "book": "fanduel"},
    },
    {
        "game": "Washington Nationals @ Baltimore Orioles",
        "home": "Baltimore Orioles",
        "away": "Washington Nationals",
        "home_stats": {"season_ppg": 4.6, "season_opp_ppg": 4.0, "last10_ppg": 4.5, "last10_opp_ppg": 3.8, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.5, "last10_ppg": 4.3, "last10_opp_ppg": 4.8, "season_pace": 1.0, "home_record_pct": 0.52, "away_record_pct": 0.44, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": -1.5, "ml_home": -142, "ml_away": 120, "total": 8.0, "book": "fanduel"},
    },
    {
        "game": "Texas Rangers @ Toronto Blue Jays",
        "home": "Toronto Blue Jays",
        "away": "Texas Rangers",
        "home_stats": {"season_ppg": 4.2, "season_opp_ppg": 4.5, "last10_ppg": 4.0, "last10_opp_ppg": 4.8, "season_pace": 1.0, "home_record_pct": 0.48, "away_record_pct": 0.42, "is_back_to_back": True, "key_injuries": 2},
        "away_stats": {"season_ppg": 4.0, "season_opp_ppg": 4.3, "last10_ppg": 4.5, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.48, "away_record_pct": 0.44, "is_back_to_back": True, "key_injuries": 1},
    ...
    },
    {
        ...
        "home_stats": {"season_ppg": 4.4, "season_opp_ppg": 3.8, "last10_ppg": 4.3, "last10_opp_ppg": 3.6, "season_pace": 1.0, "home_record_pct": 0.58, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.0, "season_opp_ppg": 3.8, "last10_ppg": 3.5, "last10_opp_ppg": 3.5, "season_pace": 1.0, "home_record_pct": 0.55, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": -1.5, "ml_home": -112, "ml_away": -104, "total": 7.5, "book": "fanduel"},
    },
    {
        "game": "Arizona Diamondbacks @ Tampa Bay Rays",
        "home": "Tampa Bay Rays",
        "away": "Arizona Diamondbacks",
        "home_stats": {"season_ppg": 4.6, "season_opp_ppg": 3.9, "last10_ppg": 5.0, "last10_opp_ppg": 3.8, "season_pace": 1.0, "home_record_pct": 0.60, "away_record_pct": 0.55, "is_back_to_back": True, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.6, "season_opp_ppg": 4.3, "last10_ppg": 4.5, "last10_opp_ppg": 4.2, "season_pace": 1.0, "home_record_pct": 0.54, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": -1.5, "ml_home": -136, "ml_away": 116, "total": 7.5, "book": "fanduel"},
    },
    {
        "game": "Philadelphia Phillies @ New York Mets",
        "home": "New York Mets",
        "away": "Philadelphia Phillies",
        "home_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.2, "last10_ppg": 3.5, "last10_opp_ppg": 5.0, "season_pace": 1.0, "home_record_pct": 0.52, "away_record_pct": 0.46, "is_back_to_back": True, "key_injuries": 1},
        "away_stats": {"season_ppg": 5.1, "season_opp_ppg": 3.8, "last10_ppg": 5.5, "last10_opp_ppg": 3.6, "season_pace": 1.0, "home_record_pct": 0.68, "away_record_pct": 0.58, "is_back_to_back": True, "key_injuries": 0},
    ...
    },
    {
        ...
        "home_stats": {"season_ppg": 4.8, "season_opp_ppg": 4.0, "last10_ppg": 4.6, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.48, "is_back_to_back": True, "key_injuries": 1},
        "away_stats": {"season_ppg": 5.0, "season_opp_ppg": 3.9, "last10_ppg": 5.0, "last10_opp_ppg": 3.6, "season_pace": 1.0, "home_record_pct": 0.68, "away_record_pct": 0.58, "is_back_to_back": True, "key_injuries": 0},
        "odds": {"spread_home": 1.5, "ml_home": -104, "ml_away": -112, "total": 8.5, "book": "fanduel"},
    },
    {
        ...
        "home_stats": {"season_ppg": 4.2, "season_opp_ppg": 4.0, "last10_ppg": 4.3, "last10_opp_ppg": 3.8, "season_pace": 1.0, "home_record_pct": 0.55, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 0},
        "away_stats": {"season_ppg": 4.2, "season_opp_ppg": 4.4, "last10_ppg": 3.8, "last10_opp_ppg": 4.5, "season_pace": 1.0, "home_record_pct": 0.50, "away_record_pct": 0.38, "is_back_to_back": False, "key_injuries": 1},
    ...
    },
    {
        ...
        "away": "Chicago Cubs",
        "home_stats": {"season_ppg": 4.8, "season_opp_ppg": 3.6, "last10_ppg": 5.0, "last10_opp_ppg": 3.4, "season_pace": 1.0, "home_record_pct": 0.66, "away_record_pct": 0.56, "is_back_to_back": False, "key_injuries": 0},
        "away_stats": {"season_ppg": 4.6, "season_opp_ppg": 4.2, "last10_ppg": 5.2, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.54, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": -1.5, "ml_home": -275, "ml_away": 220, "total": 8.0, "book": "fanduel"},
    },
    {
        "game": "Colorado Rockies @ Minnesota Twins",
        "home": "Minnesota Twins",
        "away": "Colorado Rockies",
        "home_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.0, "last10_ppg": 4.3, "last10_opp_ppg": 4.2, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.0, "season_opp_ppg": 5.2, "last10_ppg": 3.8, "last10_opp_ppg": 5.5, "season_pace": 1.0, "home_record_pct": 0.40, "away_record_pct": 0.32, "is_back_to_back": False, "key_injuries": 2},
        "odds": {"spread_home": -1.5, "ml_home": -162, "ml_away": 136, "total": 9.0, "book": "fanduel"},
    },
    {
        "game": "Miami Marlins @ St. Louis Cardinals",
        "home": "St. Louis Cardinals",
        "away": "Miami Marlins",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.2, "last10_ppg": 4.0, "last10_opp_ppg": 4.3, "season_pace": 1.0, "home_record_pct": 0.54, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 3.8, "season_opp_ppg": 4.8, "last10_ppg": 3.5, "last10_opp_ppg": 5.0, "season_pace": 1.0, "home_record_pct": 0.42, "away_record_pct": 0.36, "is_back_to_back": False, "key_injuries": 2},
        "odds": {"spread_home": -1.5, "ml_home": -107, "ml_away": -103, "total": 8.5, "book": "fanduel"},
    },
    {
        "game": "Sacramento Athletics @ Los Angeles Angels",
        "home": "Los Angeles Angels",
        "away": "Sacramento Athletics",
        "home_stats": {"season_ppg": 3.9, "season_opp_ppg": 4.6, "last10_ppg": 3.8, "last10_opp_ppg": 4.8, "season_pace": 1.0, "home_record_pct": 0.44, "away_record_pct": 0.38, "is_back_to_back": False, "key_injuries": 2},
        "away_stats": {"season_ppg": 3.8, "season_opp_ppg": 5.0, "last10_ppg": 4.0, "last10_opp_ppg": 4.8, "season_pace": 1.0, "home_record_pct": 0.42, "away_record_pct": 0.38, "is_back_to_back": False, "key_injuries": 2},
    ...
    },
    {
        ...
        "home_stats": {"season_ppg": 4.4, "season_opp_ppg": 4.0, "last10_ppg": 4.5, "last10_opp_ppg": 3.8, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 5.3, "season_opp_ppg": 3.7, "last10_ppg": 5.5, "last10_opp_ppg": 3.5, "season_pace": 1.0, "home_record_pct": 0.70, "away_record_pct": 0.60, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": 1.5, "ml_home": 126, "ml_away": -148, "total": 7.5, "book": "fanduel"},
    },
    {
        "game": "Atlanta Braves @ San Francisco Giants",
        "home": "San Francisco Giants",
        "away": "Atlanta Braves",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.5, "last10_ppg": 4.2, "last10_opp_ppg": 4.8, "season_pace": 1.0, "home_record_pct": 0.44, "away_record_pct": 0.38, "is_back_to_back": True, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.8, "season_opp_ppg": 3.8, "last10_ppg": 5.0, "last10_opp_ppg": 3.6, "season_pace": 1.0, "home_record_pct": 0.62, "away_record_pct": 0.54, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": 1.5, "ml_home": 104, "ml_away": -116, "total": 7.5, "book": "fanduel"},
    },
]
...
print(f"\n{'=' * 90}")
print(f" MLB -- Friday Jun 26, 2026")
print(f"{'=' * 90}")
...
# Score BET results from Jun 25
jun25_bets = [p for p in past_preds["predictions"] if p.get("verdict") == "BET"]
jun25_bet_wins = 0
jun25_bet_total = len(jun25_bets)
for bp in jun25_bets:
    gk = bp["game"]
...
new_bets = old_bets + jun25_bet_total
new_bets_won = old_bets_won + jun25_bet_wins

metrics["last_updated"] = TODAY
metrics["rolling_7d"] = {
    "accuracy": round(total_correct_eval / total_games_eval, 4) if total_games_eval > 0 else 0.5,
    "ev_realized": round((jun25_bet_wins * 0.909 - (jun25_bet_total - jun25_bet_wins)) / max(jun25_bet_total, 1), 4),
...
metrics["today_summary"] = {
    ...
    "leans": len(leans),
    "sports": ["baseball_mlb"],
    "notes": f"MLB only (15 games). {len(bets)} BETs, {len(leans)} LEANs. Eval Jun 25: {total_correct_eval}/{total_games_eval} correct."
}
...
print(f"  Jun 25 eval: {total_correct_eval}/{total_games_eval} = {total_correct_eval/max(total_games_eval,1):.1%} accuracy")
print(f"  Jun 25 bets: {jun25_bet_wins}/{jun25_bet_total} = {jun25_bet_wins/max(jun25_bet_total,1):.1%} hit rate")
