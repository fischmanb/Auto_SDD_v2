#!/usr/bin/env python3
"""
Edge-Finder daily runner for 2026-07-21.
Phase 1: Eval July 20 predictions (15 MLB games).
Phase 2-5: Simulate tonight's 14 MLB games (PIT@NYY postponed), produce blended predictions.
"""
...
actual_results = {
    ...
    "Miami Marlins @ Houston Astros": {"winner": "home", "home_score": 8, "away_score": 4},
...
for c in challengers:
    ...
    days_alive = (date(2026, 7, 21) - date(int(born[:4]), int(born[5:7]), int(born[8:10]))).days
...
# ═══════════════════════════════════════════════════════════════════════
# PHASE 2-5 — TONIGHT'S PREDICTIONS (July 21, 2026)
# ═══════════════════════════════════════════════════════════════════════
...
# Tuesday July 21, 2026 — MLB only (NBA/NHL/NFL off-season)
# 14 games (PIT@NYY postponed to July 22 doubleheader). Game 2 of each series.
# Odds sourced from DraftKings, FanDuel, BetMGM, Covers, ESPN, NBC Sports.
# Records approximate through July 20. Stats estimated from standings and recent form.

games_raw = [
    # 1. MIN Twins @ CLE Guardians — 6:40 PM ET
    # MIN ~42-48, CLE ~53-48 after 13-4 blowout. CLE home favorite.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 2. TB Rays @ TOR Blue Jays — 7:07 PM ET
    # TB 57-42, TOR ~40-58. TB road favorite after 7-1 win.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 3. BAL Orioles @ BOS Red Sox — 7:10 PM ET
    # BAL ~47-52, BOS ~51-48. BOS 14-game win streak, home favorite.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Boston Red Sox",
    ...
    # 4. LAD Dodgers @ PHI Phillies — 7:10 PM ET
    # LAD 63-37 (best in MLB), PHI 56-45. PHI home, Wheeler pitching.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 5. SD Padres @ ATL Braves — 7:15 PM ET
    # SD 49-51, ATL 59-41. ATL home favorite.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Atlanta Braves",
    ...
    # 6. SF Giants @ KC Royals — 7:40 PM ET
    # SF ~44-55, KC ~45-54. Near pick'em. KC slight home fav.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 7. NYM Mets @ MIL Brewers — 7:40 PM ET
    # NYM ~43-56, MIL 63-37. MIL home favorite.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 8. DET Tigers @ CHC Cubs — 8:05 PM ET
    # DET ~45-53 (won 8-6 last night), CHC 56-44. CHC slight home fav.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Chicago Cubs",
    ...
    # 9. CWS White Sox @ TEX Rangers — 8:05 PM ET
    # CWS 53-46 (won 10-3 last night), TEX 50-50. TEX home fav.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Texas Rangers",
    ...
    # 10. MIA Marlins @ HOU Astros — 8:10 PM ET
    # MIA ~35-63, HOU ~44-47. HOU home fav.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Houston Astros",
    ...
    # 11. WSH Nationals @ COL Rockies — 8:40 PM ET (Coors Field)
    # WSH ~43-57, COL ~38-60. WSH road fav. Coors inflates total.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 12. OAK Athletics @ ARI Diamondbacks — 9:40 PM ET
    # OAK ~39-60 (won 5-2 last night), ARI ~48-52. ARI heavy home fav.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 13. CIN Reds @ SEA Mariners — 9:40 PM ET
    # CIN ~45-54, SEA ~48-51. Near pick'em. SEA coming off 8-0 shutout.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 14. STL Cardinals @ LAA Angels — 10:10 PM ET
    # STL 51-48, LAA ~40-58. STL road favorite.
    {
        "sport": "baseball_mlb",
        "home": {
...
pred_data = {
    ...
    "metadata": {
        ...
        "note": "ODDS_API_KEY not configured; odds sourced from web search. PIT@NYY postponed. Tuesday game 2 of each series."
    }
}
...
# ── Display results ──────────────────────────────────────────────────
print(f"\n{'=' * 90}")
print(f" MLB — Tuesday July 21, 2026")
print(f"{'=' * 90}")
...
metrics["today_summary"] = {
    ...
    "sports": ["baseball_mlb"],
    "notes": f"MLB Tuesday slate (14 games, PIT@NYY PPD). Eval Jul 20: {eval_correct}/{eval_games} correct ({eval_acc:.0%}). Jul 20 bets: {jul20_bet_wins}/{jul20_bet_total} won. CLE 13-4 blowout of MIN (7 HR). BOS 14-game win streak."
}
