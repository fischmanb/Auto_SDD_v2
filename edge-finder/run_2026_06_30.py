#!/usr/bin/env python3
"""
Edge-Finder daily runner for 2026-06-30.
...
actual_results = {
    ...
    "Pittsburgh Pirates @ Philadelphia Phillies": {"winner": "away", "home_score": 7, "away_score": 11},
    "Detroit Tigers @ New York Yankees": {"winner": "away", "home_score": 3, "away_score": 7},
    "New York Mets @ Toronto Blue Jays": {"winner": "home", "home_score": 2, "away_score": 1},
    "Texas Rangers @ Cleveland Guardians": {"winner": "away", "home_score": 3, "away_score": 6},
    ...
    "Miami Marlins @ Colorado Rockies": {"winner": "away", "home_score": 7, "away_score": 10},
    "San Francisco Giants @ Arizona Diamondbacks": {"winner": "home", "home_score": 5, "away_score": 4},
    "Los Angeles Angels @ Seattle Mariners": {"winner": "home", "home_score": 6, "away_score": 2},
    "Los Angeles Dodgers @ Sacramento Athletics": {"winner": "away", "home_score": 4, "away_score": 9},
}
...
for c in challengers:
    born = c.get("born", "2026-03-24")
    days_alive = (date(2026, 6, 30) - date(int(born[:4]), int(born[5:7]), int(born[8:10]))).days
...
# ════════════════════════════════════════════════════════════════════════
# PHASE 2-5 — TONIGHT'S PREDICTIONS (June 30, 2026)
# ════════════════════════════════════════════════════════════════════════
...
# ── Tonight's games with odds (MLB only — NBA/NHL seasons over) ───────

games_raw = [
    # 1. Washington Nationals @ Boston Red Sox
    # BOS -134, WSH +116. Cavalli (4-4) vs Early (7-5). Series game 2.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Boston Red Sox",
    ...
    # BAL -146, CWS +124. CWS won 8-2 yesterday.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # PHI -230 big fav, PIT +190. Sanchez (9-3, 2.13) vs Chandler (3-7, 4.42).
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # NYY -142, DET +120. Schlittler vs Skubal (struggling). NYY 48-36, DET 36-49.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # TEX -122 road fav (deGrom pitching), CLE +104. deGrom (6-5) vs Bibee (2-8).
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # MIL -172 home fav, CIN +144. Lowder vs TBD.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # CHC -154 home fav, SD +130. Cubs won 3-2 yesterday.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Chicago Cubs",
    ...
    # MIN -116 slight road fav, HOU -102. Ryan (5-4) vs Burrows (3-8).
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Houston Astros",
    ...
    # MIA -162 road fav, COL +136 home dog. Coors Field.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # ARI -108 / SF -108 pick'em. Roupp vs Pfaadt. ARI won 5-4 yesterday.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # SEA -174 big fav at home, LAA +146 road dog.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # LAD -154 road fav, SAC +130. Dodgers won 9-4 yesterday. O/U 10.5.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 14. Tampa Bay Rays @ Kansas City Royals (NEW)
    # TB -116 road fav, KC +102.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 15. St. Louis Cardinals @ Atlanta Braves (NEW)
    # ATL -156 home fav, STL +132. O/U 9.5.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Atlanta Braves",
...
print(f"\n{'=' * 90}")
print(f" MLB — Tuesday June 30, 2026")
print(f"{'=' * 90}")
