#!/usr/bin/env python3
"""
Edge-Finder daily runner for 2026-07-07.
Phase 1: Eval July 5 predictions, update weights.
...
# ═══════════════════════════════════════════════════════════════════════
# PHASE 1 — EVALUATE JULY 5 PREDICTIONS
# ═══════════════════════════════════════════════════════════════════════

print("=" * 78)
print(" PHASE 1 — Evaluating 2026-07-05 predictions")
print("=" * 78)
...
actual_results = {
    "New York Mets @ Atlanta Braves": {"winner": "away", "home_score": 9, "away_score": 10},
    "Pittsburgh Pirates @ Washington Nationals": {"winner": "away", "home_score": 5, "away_score": 11},
    "Baltimore Orioles @ Cincinnati Reds": {"winner": "home", "home_score": 3, "away_score": 2},
    "Minnesota Twins @ New York Yankees": {"winner": "away", "home_score": 1, "away_score": 6},
    "Chicago White Sox @ Cleveland Guardians": {"winner": "away", "home_score": 6, "away_score": 7},
    "St. Louis Cardinals @ Chicago Cubs": {"winner": "home", "home_score": 6, "away_score": 4},
    "Philadelphia Phillies @ Kansas City Royals": {"winner": "home", "home_score": 5, "away_score": 2},
    "Tampa Bay Rays @ Houston Astros": {"winner": "home", "home_score": 2, "away_score": 0},
    "Detroit Tigers @ Texas Rangers": {"winner": "away", "home_score": 3, "away_score": 6},
    "San Francisco Giants @ Colorado Rockies": {"winner": "home", "home_score": 7, "away_score": 6},
    "Miami Marlins @ Sacramento Athletics": {"winner": "away", "home_score": 8, "away_score": 9},
    "Milwaukee Brewers @ Arizona Diamondbacks": {"winner": "away", "home_score": 2, "away_score": 3},
    "Toronto Blue Jays @ Seattle Mariners": {"winner": "home", "home_score": 4, "away_score": 0},
    "Boston Red Sox @ Los Angeles Angels": {"winner": "away", "home_score": 5, "away_score": 7},
    "San Diego Padres @ Los Angeles Dodgers": {"winner": "away", "home_score": 2, "away_score": 5},
}
...
for c in challengers:
    ...
    days_alive = (date(2026, 7, 7) - date(int(born[:4]), int(born[5:7]), int(born[8:10]))).days
...
# ═══════════════════════════════════════════════════════════════════════
# PHASE 2-5 — TONIGHT'S PREDICTIONS (July 7, 2026)
# ═══════════════════════════════════════════════════════════════════════
...
# Tuesday July 7, 2026 — MLB only (NBA/NHL/NFL off-season)
# All odds sourced from FanDuel/DraftKings/BetMGM/Covers via web search

games_raw = [
    # 1. MIL Brewers @ STL Cardinals (Game 1 of DH)
    # MIL 56-33, STL 47-41. Gasser vs Dobbins.
    # MIL dominant road team. STL middling at home.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 2. CHC Cubs @ BAL Orioles
    # Interleague. CHC -112, BAL -104. Total 9.5.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 3. SAC Athletics @ DET Tigers
    # DET -205, SAC +172. Under 7.5.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Detroit Tigers",
    ...
    # 4. ATL Braves @ PIT Pirates
    # ATL +149, PIT -181. Pirates big home favorites.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 5. SEA Mariners @ MIA Marlins
    # SEA -102, MIA -116. Tight game.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Miami Marlins",
    ...
    # 6. NYY Yankees @ TB Rays
    # NYY +100, TB -120. Total 8.0.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Tampa Bay Rays",
    ...
    # 7. HOU Astros @ WAS Nationals
    # HOU +101, WAS -122. Total 9.5.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 8. BOS Red Sox @ CHW White Sox
    # BOS -120, CHW +102. Total 8.5.
    # Tolle (4-6, 3.39) vs Schultz (2-5, 5.86).
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 9. KC Royals @ NYM Mets
    # KC +124, NYM -146. Total 8.5.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "New York Mets",
    ...
    # 10. LAA Angels @ TEX Rangers
    # LAA +138, TEX -167. Total 7.0.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Texas Rangers",
    ...
    # 11. ARI Diamondbacks @ SD Padres
    # ARI +109, SD -131. Total 8.5.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 12. TOR Blue Jays @ SF Giants
    # TOR -115, SF -105. Total 7.5.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 13. COL Rockies @ LAD Dodgers
    # COL +235, LAD -290. Total 9.5.
    # Wrobleski (10-2, 2.80) vs Lorenzen (3-9, 6.91).
    # Dodgers 60-32, Rockies 37-55.
    {
        "sport": "baseball_mlb",
        "home": {
...
# ── Display results ──────────────────────────────────────────────────
print(f"\n{'=' * 90}")
print(f" MLB — Tuesday July 7, 2026")
print(f"{'=' * 90}")
...
jul5_bets = [p for p in past_preds["predictions"] if p["verdict"] == "BET"]
jul5_bet_wins = 0
jul5_bet_total = len(jul5_bets)
for bp in jul5_bets:
    gk = bp["game"]
    ...
    if bt == "ml_ev_home":
        ...
        bt = "ml_away"
    elif bt == "spread_ev_home":
        bt = "spread_home"
    elif bt == "spread_ev_away":
        bt = "spread_away"
    if bt == "spread_home":
        won = (margin + spread) > 0
    elif bt == "spread_away":
...
new_all_bets = prev_all["total_bets_recommended"] + jul5_bet_total
new_all_bets_won = prev_all["total_bets_won"] + jul5_bet_wins

metrics["last_updated"] = TODAY
metrics["rolling_7d"] = {
    "accuracy": round(eval_correct / eval_games, 4) if eval_games > 0 else 0.5,
    "ev_realized": round((jul5_bet_wins * 0.909 - (jul5_bet_total - jul5_bet_wins)) / max(jul5_bet_total, 1), 4),
...
metrics["today_summary"] = {
    ...
    "notes": f"MLB Tuesday slate (13 games). {total_bets_today} BETs, {total_leans_today} LEANs. Eval Jul 5: {eval_correct}/{eval_games} correct."
}
...
print(f"  Jul 5 eval: {eval_correct}/{eval_games} = {eval_acc:.1%} accuracy")
print(f"  Jul 5 bets: {jul5_bet_wins}/{jul5_bet_total} = {jul5_bet_wins/max(jul5_bet_total,1):.1%} hit rate")
