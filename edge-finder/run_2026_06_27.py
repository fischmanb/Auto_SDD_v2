#!/usr/bin/env python3
"""
Edge-Finder daily runner for 2026-06-27 (Saturday).
...
# Actual results from June 26, 2026 — verified via ESPN/MLB.com/CBS Sports/Baseball-Reference
actual_results = {
    ...
    "Washington Nationals @ Baltimore Orioles": {"winner": "home", "home_score": 3, "away_score": 1},
...
for challenger in assumptions["challengers"][:]:
    if challenger["weight"] <= 0.15 and challenger.get("born", "2026-01-01") < "2026-06-22":
        ...
        new_challenger = {
            "id": "pitching-matchup-v1",
            "description": "Pitcher-era-adjusted model: adjusts expected runs by weighting recent pitching matchup quality. Hypothesis: starting pitcher quality dominates day-to-day MLB variance more than team-level batting/fielding stats.",
            "weight": 0.5,
            "born": TODAY,
            "grace_until": "2026-07-02",
            "params": {
                "recency_weight": 1.5,
                "injury_discount": 0.5,
...
# ════════════════════════════════════════════════════════════════════════
# PHASE 2 — DATA COLLECTION: Tonight's games (June 27, 2026 MLB)
# ════════════════════════════════════════════════════════════════════════

print(f"\n{'=' * 78}")
print(f" PHASE 2 — Data Collection: June 27, 2026 MLB games (15 games)")
print(f"{'=' * 78}")

# Tonight's 15 games and odds sourced via web search (FanDuel, BetMGM, ESPN, DraftKings)
# Team stats carried from Jun 26 baseline with minor adjustments.
# Records: ATL 49-31, LAD 52-30, MIL ~51-28, NYY ~48-33, DET 36-47,
# CHW 42-38, SAC 40-42, SF 33-48, KC 34-49, LAA 34-49, COL ~32-50
games_today = [
    {
        "game": "Houston Astros @ Detroit Tigers",
        "home": "Detroit Tigers",
        "away": "Houston Astros",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.1, "last10_ppg": 4.4, "last10_opp_ppg": 3.9, "season_pace": 1.0, "home_record_pct": 0.55, "away_record_pct": 0.46, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.4, "season_opp_ppg": 4.0, "last10_ppg": 4.3, "last10_opp_ppg": 4.1, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
    ...
    },
    {
        ...
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.1, "last10_ppg": 4.2, "last10_opp_ppg": 3.9, "season_pace": 1.0, "home_record_pct": 0.52, "away_record_pct": 0.46, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.1, "season_opp_ppg": 4.5, "last10_ppg": 4.0, "last10_opp_ppg": 4.5, "season_pace": 1.0, "home_record_pct": 0.46, "away_record_pct": 0.40, "is_back_to_back": False, "key_injuries": 1},
    ...
    },
    {
        ...
        "away_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.5, "last10_ppg": 4.2, "last10_opp_ppg": 4.9, "season_pace": 1.0, "home_record_pct": 0.52, "away_record_pct": 0.44, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": -1.5, "ml_home": -122, "ml_away": 101, "total": 8.0, "book": "fanduel"},
    },
    {
        "game": "Texas Rangers @ Toronto Blue Jays",
        "home": "Toronto Blue Jays",
        "away": "Texas Rangers",
        "home_stats": {"season_ppg": 4.2, "season_opp_ppg": 4.5, "last10_ppg": 4.0, "last10_opp_ppg": 4.7, "season_pace": 1.0, "home_record_pct": 0.48, "away_record_pct": 0.42, "is_back_to_back": False, "key_injuries": 2},
        "away_stats": {"season_ppg": 4.0, "season_opp_ppg": 4.3, "last10_ppg": 4.5, "last10_opp_ppg": 4.0, "season_pace": 1.0, "home_record_pct": 0.48, "away_record_pct": 0.44, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": -1.5, "ml_home": -180, "ml_away": 152, "total": 8.5, "book": "fanduel"},
    },
    {
        "game": "Seattle Mariners @ Cleveland Guardians",
        "home": "Cleveland Guardians",
        "away": "Seattle Mariners",
        "home_stats": {"season_ppg": 4.4, "season_opp_ppg": 3.8, "last10_ppg": 4.2, "last10_opp_ppg": 3.7, "season_pace": 1.0, "home_record_pct": 0.58, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.0, "season_opp_ppg": 3.8, "last10_ppg": 3.7, "last10_opp_ppg": 3.4, "season_pace": 1.0, "home_record_pct": 0.55, "away_record_pct": 0.50, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": 1.5, "ml_home": 130, "ml_away": -154, "total": 8.0, "book": "fanduel"},
    },
    {
        "game": "Arizona Diamondbacks @ Tampa Bay Rays",
        "home": "Tampa Bay Rays",
        "away": "Arizona Diamondbacks",
        "home_stats": {"season_ppg": 4.6, "season_opp_ppg": 3.9, "last10_ppg": 5.1, "last10_opp_ppg": 3.7, "season_pace": 1.0, "home_record_pct": 0.60, "away_record_pct": 0.55, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.6, "season_opp_ppg": 4.3, "last10_ppg": 4.4, "last10_opp_ppg": 4.3, "season_pace": 1.0, "home_record_pct": 0.54, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
    ...
    },
    {
        ...
        "home_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.2, "last10_ppg": 3.4, "last10_opp_ppg": 5.0, "season_pace": 1.0, "home_record_pct": 0.52, "away_record_pct": 0.46, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 5.1, "season_opp_ppg": 3.8, "last10_ppg": 5.4, "last10_opp_ppg": 3.7, "season_pace": 1.0, "home_record_pct": 0.68, "away_record_pct": 0.58, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": -1.5, "ml_home": -136, "ml_away": 116, "total": 8.5, "book": "fanduel"},
    },
    {
        "game": "New York Yankees @ Boston Red Sox",
        "home": "Boston Red Sox",
        "away": "New York Yankees",
        "home_stats": {"season_ppg": 4.8, "season_opp_ppg": 4.0, "last10_ppg": 4.7, "last10_opp_ppg": 3.9, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 5.0, "season_opp_ppg": 3.9, "last10_ppg": 4.8, "last10_opp_ppg": 3.7, "season_pace": 1.0, "home_record_pct": 0.68, "away_record_pct": 0.58, "is_back_to_back": False, "key_injuries": 0},
    ...
    },
    {
        ...
        "home_stats": {"season_ppg": 4.2, "season_opp_ppg": 4.0, "last10_ppg": 4.5, "last10_opp_ppg": 3.7, "season_pace": 1.0, "home_record_pct": 0.55, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 0},
        "away_stats": {"season_ppg": 4.2, "season_opp_ppg": 4.4, "last10_ppg": 3.7, "last10_opp_ppg": 4.6, "season_pace": 1.0, "home_record_pct": 0.50, "away_record_pct": 0.38, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": -1.5, "ml_home": -145, "ml_away": 118, "total": 8.5, "book": "fanduel"},
    },
    {
        "game": "Chicago Cubs @ Milwaukee Brewers",
        "home": "Milwaukee Brewers",
        "away": "Chicago Cubs",
        "home_stats": {"season_ppg": 4.8, "season_opp_ppg": 3.6, "last10_ppg": 5.1, "last10_opp_ppg": 3.4, "season_pace": 1.0, "home_record_pct": 0.66, "away_record_pct": 0.56, "is_back_to_back": False, "key_injuries": 0},
        "away_stats": {"season_ppg": 4.6, "season_opp_ppg": 4.2, "last10_ppg": 5.0, "last10_opp_ppg": 4.1, "season_pace": 1.0, "home_record_pct": 0.54, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 0},
        "odds": {"spread_home": -1.5, "ml_home": -164, "ml_away": 138, "total": 8.0, "book": "fanduel"},
    },
    {
        "game": "Colorado Rockies @ Minnesota Twins",
        "home": "Minnesota Twins",
        "away": "Colorado Rockies",
        "home_stats": {"season_ppg": 4.5, "season_opp_ppg": 4.0, "last10_ppg": 4.4, "last10_opp_ppg": 4.1, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 4.0, "season_opp_ppg": 5.2, "last10_ppg": 3.9, "last10_opp_ppg": 5.4, "season_pace": 1.0, "home_record_pct": 0.40, "away_record_pct": 0.32, "is_back_to_back": False, "key_injuries": 2},
        "odds": {"spread_home": -1.5, "ml_home": -172, "ml_away": 144, "total": 9.5, "book": "fanduel"},
    },
    {
        "game": "Miami Marlins @ St. Louis Cardinals",
        "home": "St. Louis Cardinals",
        "away": "Miami Marlins",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.2, "last10_ppg": 3.9, "last10_opp_ppg": 4.4, "season_pace": 1.0, "home_record_pct": 0.54, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 3.8, "season_opp_ppg": 4.8, "last10_ppg": 3.6, "last10_opp_ppg": 4.9, "season_pace": 1.0, "home_record_pct": 0.42, "away_record_pct": 0.36, "is_back_to_back": False, "key_injuries": 2},
        "odds": {"spread_home": -1.5, "ml_home": -145, "ml_away": 118, "total": 8.5, "book": "fanduel"},
    },
    {
        ...
        "home_stats": {"season_ppg": 3.9, "season_opp_ppg": 4.6, "last10_ppg": 3.7, "last10_opp_ppg": 4.9, "season_pace": 1.0, "home_record_pct": 0.44, "away_record_pct": 0.38, "is_back_to_back": False, "key_injuries": 2},
        "away_stats": {"season_ppg": 3.8, "season_opp_ppg": 5.0, "last10_ppg": 4.1, "last10_opp_ppg": 4.7, "season_pace": 1.0, "home_record_pct": 0.42, "away_record_pct": 0.38, "is_back_to_back": False, "key_injuries": 2},
    ...
    },
    {
        ...
        "home_stats": {"season_ppg": 4.4, "season_opp_ppg": 4.0, "last10_ppg": 4.7, "last10_opp_ppg": 3.7, "season_pace": 1.0, "home_record_pct": 0.56, "away_record_pct": 0.48, "is_back_to_back": False, "key_injuries": 1},
        "away_stats": {"season_ppg": 5.3, "season_opp_ppg": 3.7, "last10_ppg": 5.3, "last10_opp_ppg": 3.6, "season_pace": 1.0, "home_record_pct": 0.70, "away_record_pct": 0.60, "is_back_to_back": False, "key_injuries": 1},
        "odds": {"spread_home": 1.5, "ml_home": 172, "ml_away": -205, "total": 8.0, "book": "fanduel"},
    },
    {
        "game": "Atlanta Braves @ San Francisco Giants",
        "home": "San Francisco Giants",
        "away": "Atlanta Braves",
        "home_stats": {"season_ppg": 4.3, "season_opp_ppg": 4.5, "last10_ppg": 4.1, "last10_opp_ppg": 4.9, "season_pace": 1.0, "home_record_pct": 0.44, "away_record_pct": 0.38, "is_back_to_back": False, "key_injuries": 1},
        ...
        "odds": {"spread_home": -1.5, "ml_home": -136, "ml_away": 116, "total": 8.0, "book": "fanduel"},
    },
]
...
print(f"\n{'=' * 90}")
print(f" MLB -- Saturday Jun 27, 2026")
print(f"{'=' * 90}")
...
# Score BET results from Jun 26
jun26_bets = [p for p in past_preds["predictions"] if p.get("verdict") == "BET"]
jun26_bet_wins = 0
...
new_bets = old_bets + jun26_bet_total
new_bets_won = old_bets_won + jun26_bet_wins
...
metrics["today_summary"] = {
    ...
    "leans": len(leans),
    "sports": ["baseball_mlb"],
    "notes": f"MLB only (15 games). {len(bets)} BETs, {len(leans)} LEANs. Eval Jun 26: {total_correct_eval}/{total_games_eval} correct."
}
...
print(f"  Jun 26 eval: {total_correct_eval}/{total_games_eval} = {total_correct_eval/max(total_games_eval,1):.1%} accuracy")
