#!/usr/bin/env python3
"""
Edge-Finder daily runner for 2026-07-12.
...
# Actual results from July 10, 2026 (sourced via ESPN, MLB.com, Baseball-Reference)
# MIL @ PIT was postponed (rain), rescheduled as doubleheader July 11.
actual_results = {
...
print(f"(Milwaukee Brewers @ Pittsburgh Pirates postponed — rain; rescheduled as DH on 7/11)")
...
for c in challengers:
    ...
    days_alive = (date(2026, 7, 12) - date(int(born[:4]), int(born[5:7]), int(born[8:10]))).days
...
# ═══════════════════════════════════════════════════════════════════════
# PHASE 2-5 — TONIGHT'S PREDICTIONS (July 12, 2026)
# ═══════════════════════════════════════════════════════════════════════
...
# Sunday July 12, 2026 — MLB only (NBA/NHL/NFL off-season)
# 14 games. Last day before All-Star break.
# Odds sourced from FanDuel/DraftKings/Covers/ESPN via web search.
# MIL @ PIT not playing today (played DH on July 11).

games_raw = [
    # 1. KC Royals @ BAL Orioles — 12:15 PM ET (Peacock)
    # KC ~44-50, BAL ~50-44. Orioles home favorites. Basallo homered yesterday.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 2. NYY Yankees @ WSH Nationals — 1:35 PM ET
    # NYY 53-42, WSH ~43-50. Nationals home favorites per odds (-120).
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 3. CHC Cubs @ CIN Reds — 1:40 PM ET
    # CHC ~46-49, CIN ~48-46. Burns to ASG. Cubs slight road favorites (-118).
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 4. BOS Red Sox @ NYM Mets — 1:40 PM ET
    # BOS 45-48 (hot, 10 of 12), NYM 40-56 (struggling). Near pick'em.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "New York Mets",
    ...
    # 5. SEA Mariners @ TB Rays — 1:40 PM ET
    # SEA 47-49, TB 56-37. Rays home favorites. Caminero hot (28 HR).
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Tampa Bay Rays",
    ...
    # 6. PHI Phillies @ DET Tigers — 1:40 PM ET
    # PHI 52-42, DET ~49-44. Tigers won 10-2 Friday. Phillies road favorites (-142).
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Detroit Tigers",
    ...
    # 7. CLE Guardians @ MIA Marlins — 1:40 PM ET
    # CLE 50-46, MIA ~36-58. Near pick'em per odds. Phillips vs Cantillo.
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Miami Marlins",
    ...
    # 8. LAA Angels @ MIN Twins — 2:10 PM ET
    # LAA 38-57, MIN 46-49. Twins home favorites (-130).
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 9. ATH Athletics @ CWS White Sox — 2:10 PM ET
    # ATH 41-53, CWS 49-45. White Sox home favorites (-144). Peters hit for cycle Fri.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 10. ATL Braves @ STL Cardinals — 2:15 PM ET
    # ATL 54-40, STL ~47-47. Cardinals home favorites (~61% win prob).
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 11. HOU Astros @ TEX Rangers — 2:35 PM ET
    # HOU ~46-48, TEX 48-47. Rangers home favorites (-136).
    {
        "sport": "baseball_mlb",
        "home": {
            "name": "Texas Rangers",
    ...
    # 12. COL Rockies @ SF Giants — 4:05 PM ET
    # COL ~35-59, SF ~42-52. Giants home favorites (-148). Lorenzen vs McDonald.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 13. ARI Diamondbacks @ LAD Dodgers — 4:10 PM ET
    # ARI ~48-46, LAD 61-35. Dodgers heavy favorites (-280). Ohtani scratched Fri.
    {
        "sport": "baseball_mlb",
        "home": {
    ...
    # 14. TOR Blue Jays @ SD Padres — 4:10 PM ET
    # TOR ~44-50, SD ~45-49. Blue Jays road favorites. Okamoto (22 HR) hot.
    {
        "sport": "baseball_mlb",
        "home": {
...
# ── Display results ──────────────────────────────────────────────────
print(f"\n{'=' * 90}")
print(f" MLB — Sunday July 12, 2026 (Last day before All-Star break)")
print(f"{'=' * 90}")
...
metrics["today_summary"] = {
    ...
    "sports": ["baseball_mlb"],
    "notes": f"MLB Sunday slate (14 games, last day pre-ASB). {total_bets_today} BETs, {total_leans_today} LEANs. Eval Jul 10: {eval_correct}/{eval_games} correct."
}
